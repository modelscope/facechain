...
def restore_lora(pipeline,
    ...
    for layer, elems in updates.items():
        ...
        curr_layer.weight.data = curr_layer.weight.data.to(device)
        curr_layer.weight.data = curr_layer.weight.data_restore.clone()
