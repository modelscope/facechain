...
styles = [
    ...
    {'name': '西部风(wild west style)',
     'model_id': 'custom_style_loras/wild_west',
     'revision': 'v1.0.0',
    ...
    {'name': '中国风(traditional chinese style suit)',
     'model_id': 'custom_style_loras/chinese_traditional',
     'revision': 'v1.0.0',
     'bin_file': 'chinese.safetensors',
     'multiplier_style': 0.35,
     'multiplier_human': 0.95,
     'cloth_name': '中国风(chinese)',
    ...
    {'name': '科幻风(science fiction style suit)',
     'model_id': 'custom_style_loras/science_fiction',
     'revision': 'v1.0.0',
     'bin_file': 'scific.safetensors',
     'multiplier_style': 0.35,
     'multiplier_human': 0.95,
     'cloth_name': '科幻风(sci-fic)',
