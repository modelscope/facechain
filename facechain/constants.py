...
base_models = [
    ...
    'revision': 'v2.0',
    'sub_path': "film/film",
    'style_list': ['熔岩(flame)','婚礼(wedding)','工作服(Working suit)', '盔甲风(Armor)','T恤衫(T-shirt)','汉服风(Hanfu)','女士晚礼服(Gown)','赛博朋克(Cybernetics punk)','凤冠霞帔(Chinese traditional gorgeous suit)','星空风(starfield)','星球大战(starwars)','亚洲休闲风(Asian)','欧洲冠军杯(UEFA)']},
...
styles = [
    {'name': '熔岩(flame)',
     ...
     'model_id': 'connected/ZJU3_lishiyu_zhoujingchang',
     'revision': None,
    ...
    {'name': '凤冠霞帔(Chinese traditional gorgeous suit)',
     ...
     'add_prompt_style': 'handsome boy, riding on a awesome motorbike, wearing racing clothes, motorbike clothes, sunglassed, playful, futuristic, in the desert, at daytime, hot atmospheric, realistic'},
