...
base_models = [
    ...
    'revision': 'v1.0.0',
    'sub_path': "realistic",
    'style_list': ['泛光灯效果(floods)', '水墨画风(ink and wash painting)', '壮族服装风(zhuangzu)', '欧式服装风(european)', '巴伐利亚风(dirndl)', '旗袍风(qipao)', '冬季汉服(Chinese winter hanfu)', '校服风(School uniform)', '婚纱风(Wedding dress)', '拍立得风(Polaroid style)', '仙女风(Fairy style)']},
]
...
styles = [
    ...
    {'name': '泛光灯效果(floods)',
     ...
     'add_prompt_style': '(masterpiece, highres, best quality, ultra detailed, detailed background, cinematic lighting:1.2), focused'},
    {'name': '水墨画风(ink and wash painting)',
     'model_id': 'iotang/lora_testing',
     'revision': 'v5',
     ...
     'add_prompt_style': '(ultra high res face, face ultra zoom, highres, best quality, ultra detailed, detailed background, cinematic lighting, portrait:1.2), sfw, shuimobysim, song, anxiang, badashanren, Chinese traditional ink painting, Ultra HD, depth of field, traditional Chinese ink drawing of a beautiful woman standing, smile, goodhands-beta2, wuchangshuo, hanfu, bamboo in background, looking at viewer, serenity, peace'},
    {'name': '壮族服装风(zhuangzu)',
     'model_id': 'iotang/lora_testing',
     'revision': 'v5',
     ...
     'add_prompt_style': '(ultra high res face, face ultra zoom, highres, best quality, ultra detailed, detailed background, cinematic lighting, portrait:1.2), sfw, facing the camera with a smile, zhuangzunv, KPG woman wearing the zhuangzunv, beautiful embroidery, floral print, marvelous design, ancient Chinese traditional clothing'},
    {'name': '欧式服装风(european)',
     'model_id': 'iotang/lora_testing',
     'revision': 'v5',
     ...
     'multiplier_style': 0.5,
     'multiplier_human': 0.8,
     'cloth_name': '欧式服装风(european)',
     'add_prompt_style': '(ultra high res face, face ultra zoom, highres, best quality, ultra detailed, detailed background, cinematic lighting, portrait:1.2), sfw, focused, edgEV, wearing edgEV_vintage dress, field, natural lighting'},
    {'name': '巴伐利亚风(dirndl)',
     'model_id': 'iotang/lora_testing',
     'revision': 'v5',
     'bin_file': 'dirndl.safetensors',
     'multiplier_style': 0.5,
     'multiplier_human': 0.8,
     'cloth_name': '巴伐利亚风(dirndl)',
     'add_prompt_style': '(ultra high res face, face ultra zoom, highres, best quality, ultra detailed, detailed background, cinematic lighting, portrait:1.2), sfw, focused, dirndl, a woman in traditional bavarian dress poses for a picture, wearing a dirndl'},
    {'name': '旗袍风(qipao)',
     'model_id': 'iotang/lora_testing',
     'revision': 'v5',
     ...
     'add_prompt_style': '(ultra high res face, face ultra zoom, highres, best quality, ultra detailed, detailed background, cinematic lighting, portrait:1.2), (realistic, photo-realistic:1.4), sfw, focused, qipao'},
