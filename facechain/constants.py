...
styles = [
    ...
    {'name': '京剧名旦风(Female role in Peking opera)',
     ...
     'multiplier_style': 0.45,
     'multiplier_human': 0.95,
     'add_prompt_style': 'portraits, standing, black hair, (photorealistic:1.4), official art, unity 8k wallpaper, ultra detailed, beautiful and aesthetic, masterpiece, (fractal art), 1girl, bust, wide aperture, Peking Opera, light makeup, Close-up of the face, the face is clear, no headdress, standing'},
    {'name': '自然清冷风(Cool tones)',
     ...
     'multiplier_human': 0.95,
     'add_prompt_style': 'cool, photorealisitc face, hyper realistic, ultra high res, (photorealistic:1.4), 1girl, high def, beautiful, (cleavage:1.2), intricate full color portrait, sharp focus, natural lighting, subsurface scattering'},
