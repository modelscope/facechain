...
base_models = [
    ...
    'revision': 'v2.0',
    'sub_path': "film/film",
    'style_list': ['工作服(Working suit)', '中秋(mid autumn dress)','新式铠甲(new armor)','简易赛博朋克(simple cyberpunk)','旗袍(chinese dress)','盔甲风(Armor)','T恤衫(T-shirt)','汉服风(Hanfu)','女士晚礼服(Gown)','赛博朋克(Cybernetics punk)','凤冠霞帔(Chinese traditional gorgeous suit)','休闲生活风(Casual Lifestyle)','梅花女孩(Chinese Girl among Plum Blossoms)','芭比娃娃(Barbie Doll)','白月光(Innocent Girl in White Dress)','优雅公主(Elegant Princess)','鬼马少女(Pixy Girl)']},
    {'name': 'MajicmixRealistic_v6',
    'model_id': 'YorickHe/majicmixRealistic_v6',
    'revision': 'v1.0.0',
    'sub_path': "realistic",
    'style_list': ['冬季汉服(Chinese winter hanfu)','中秋(mid autumn dress)','新式铠甲(new armor)','简易赛博朋克(simple cyberpunk)','旗袍(chinese dress)','校服风(School uniform)', '婚纱风(Wedding dress)', '夜景港风(Hong Kong night style)', '雨夜(Rainy night)', '模特风(Model style)', '机车风(Motorcycle race style)', '婚纱风-2(Wedding dress 2)','拍立得风(Polaroid style)', '仙女风(Fairy style)', '古风(traditional chinese style)', '壮族服装风(Zhuang style)', '欧式田野风(European fields)', '雪山羽绒服风(Jacket in Snow Mountain)', '旗袍风(Cheongsam)', '日系和服风(Kimono Style)', '贵族公主风(Princess costum)','机械风(Mechanical)','林中鹿女风(deer girl)','漫画风(cartoon)']},
]
...
styles = [
    ...
    {'name': '新式铠甲(new armor)',
     'img': './style_image/new_armor.jpg',
     'model_id': 'new_armor_lora',
     'revision': 'v1.0.0',
     'bin_file': 'armor.safetensors',
     'multiplier_style': 0.35,
     'multiplier_human': 0.95,
     'add_prompt_style': 'solo,clean face,armor,shoulder armor,detailed,realistic,ponytail,belt,palace background,sheath,gem,walking sabre,unsheating,facial hair,pauldrons,helmet'},
    {'name': '简易赛博朋克(simple cyberpunk)',
     'img': './style_image/cyberpunk.jpg',
     'model_id': 'cyberpunk_lora',
     'revision': 'v1.0.0',
     'bin_file': 'cyberpunk.safetensors',
     'multiplier_style': 0.35,
     'multiplier_human': 0.95,
     'add_prompt_style': 'solo,mecha,cyberpunk,ponytail,clean face,detailed,space helmet,armor,portrait,realistic,science fiction,headset,spacesuit,breasts,helmeted,power armor,braid,halo,city'},
    {'name': '旗袍(chinese dress)',
     'img': './style_image/genshindress.jpg',
     'model_id': '.genshin_dress',
     'revision': 'v1.0.0',
     'bin_file': 'genshin.safetensors',
     'multiplier_style': 0.35,
     'multiplier_human': 0.95,
     'add_prompt_style': 'looking at viewer,cheongsam,detailed,breasts,solo,bangs,dress,chinese clothes,medium breasts,hair ornament,closed mouth,china dress,alternate costume,blush,bare shoulders,ponytail,sleeveless,kamisato ayaka,flower knot'},
    {'name': '中秋(mid autumn dress)',
     'img': './style_image/midautumn.jpg',
     'model_id': 'zjuluhui/zhongqiu_dress_lora',
     'revision': 'v1.0.0',
     'bin_file': 'zhongqiu.safetensors',
     'multiplier_style': 0.30,
     'multiplier_human': 0.95,
     'add_prompt_style': 'solo,detailed,clean face,hair ornament,enjoy the full moon,fairy,jewelry,dress,earrings,flower,necklace,long sleeves,hair flower,holding,chinese clothes,hanfu,makeup,lipstick,hair bun,looking at viewer,bun'},
    {'name': '盔甲风(Armor)',
