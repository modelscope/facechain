...
base_models = [
    ...
    'revision': 'v2.0',
    'sub_path': "film/film",
    'style_list': ['工作服(Working suit)','新式铠甲(new armor)','简易赛博朋克(simple cyberpunk)','旗袍(chinese dress)', '盔甲风(Armor)','T恤衫(T-shirt)','汉服风(Hanfu)','女士晚礼服(Gown)','赛博朋克(Cybernetics punk)','凤冠霞帔(Chinese traditional gorgeous suit)']},
...
styles = [
    ...
    {'name': '新式铠甲(new armor)',
     'img': './style_image/out2.jpg',
     'model_id': 'new_armor_lora',
     'revision': 'v1.0.0',
     'bin_file': 'armor.safetensors',
     'multiplier_style': 0.35,
     'multiplier_human': 0.95,
     'add_prompt_style': 'solo,shoulder armor,realistic,weapon,holding,ponytail,belt,sword,sheath,gem,knife,unsheating,mole,facial hair,pauldrons,helmet'},
    {'name': '简易赛博朋克(simple cyberpunk)',
     'img': './style_image/out3.jpg',
     'model_id': 'cyberpunk_lora',
     'revision': 'v1.0.0',
     'bin_file': 'cyberpunk.safetensors',
     'multiplier_style': 0.35,
     'multiplier_human': 0.95,
     'add_prompt_style': 'solo,armor,portrait,realistic,science fiction,headset,profile,spacesuit,bodysuit,glasses,zipper,breasts,power armor,tattoo,braid,mole,space helmet,ahoge,halo,ponytail,Urban background'},
    {'name': '旗袍(chinese dress)',
     'img': './style_image/out4.jpg',
     'model_id': '.genshin_dress',
     'revision': 'v1.0.0',
     'bin_file': 'genshin.safetensors',
     'multiplier_style': 0.35,
     'multiplier_human': 0.95,
     'add_prompt_style': 'looking at viewer,breasts,solo,bangs,dress,chinese clothes,medium breasts,hair ornament,closed mouth,china dress,alternate costume,blush,bare shoulders,ponytail,sleeveless,kamisato ayaka,flower knot'},
    {'name': '盔甲风(Armor)',
