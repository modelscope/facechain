...
styles = [
    ...
    {'name': '，民国风(MinGuo)',
     'img': './style_image/Minguo.jpg',
     'model_id': 'HowardB/facechain_zju_19_lora',
     'revision': 'v1.0.6',
     'bin_file': 'minguo_final.safetensors',
     'multiplier_style': 0.4,
     'multiplier_human': 1,
     'add_prompt_style': '{straight_hair : 2},mg_set,blue shirt,Chinese traditional clothes, photography, warm light, soft lighting, outdoor scene,{close-up:2},{faceshot:2},front view,Bokeh,braids,bangs,reserved, serenity, smart, facing the camera with a smile, upper_body, raw photo, masterpiece, solo, medium shot, high detail face, slim body, photorealistic, best quality'},
]
