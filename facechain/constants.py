...
styles = [
    {'name': '工作服(Working suit)',
     'img': f'{project_dir}/style_image/Working_suit.jpg',
     'model_id': None,
     'revision': None,
     'bin_file': None,
    ...
    {'name': '盔甲风(Armor)',
     'img': f'{project_dir}/style_image/Armor.jpg',
     'model_id': None,
     'revision': None,
     'bin_file': None,
     'multiplier_style': 0.35,
    ...
    {'name': 'T恤衫(T-shirt)',
     'img': f'{project_dir}/style_image/T-shirt.jpg',
     'model_id': None,
     'revision': None,
     'bin_file': None,
     'multiplier_style': 0.35,
    ...
    {'name': '汉服风(Hanfu)',
     'img': f'{project_dir}/style_image/Hanfu.jpg',
     'model_id': None,
     'revision': None,
     'bin_file': None,
     'multiplier_style': 0.35,
    ...
    {'name': '女士晚礼服(Gown)',
     'img': f'{project_dir}/style_image/Gown.jpg',
     'model_id': None,
     'revision': None,
     'bin_file': None,
     'multiplier_style': 0.35,
    ...
    {'name': '赛博朋克(Cybernetics punk)',
     'img': f'{project_dir}/style_image/Cybernetics_punk.jpg',
     'model_id': None,
     'revision': None,
     'bin_file': None,
     'multiplier_style': 0.35,
    ...
    {'name': '凤冠霞帔(Chinese traditional gorgeous suit)',
     'img': f'{project_dir}/style_image/Chinese_traditional_gorgeous_suit.jpg',
     ...
     'img': f'{project_dir}/style_image/Chinese_winter_hanfu.jpg',
     ...
     'img': f'{project_dir}/style_image/School_uniform.jpg',
     ...
     'img': f'{project_dir}/style_image/Wedding_dress.jpg',
     ...
     'img': f'{project_dir}/style_image/Hong_Kong_night_style.jpg',
     ...
     {'name': '雨夜(Rainy night)',
     'img': f'{project_dir}/style_image/Rainy_night.jpg',
     'model_id': 'YorickHe/polaroid_lora',
     'revision': 'v1.0.0',
     'bin_file': 'InstantPhotoX3.safetensors',
     ...
     'img': f'{project_dir}/style_image/Model_style.jpg',
     'model_id': 'YorickHe/polaroid_lora',
     'revision': 'v1.0.0',
     'bin_file': 'InstantPhotoX3.safetensors',
     'multiplier_style': 0.3,
     ...
     'img': f'{project_dir}/style_image/Motorcycle_race_style.jpg',
     'model_id': 'YorickHe/polaroid_lora',
     'revision': 'v1.0.0',
     'bin_file': 'InstantPhotoX3.safetensors',
     ...
     'img': f'{project_dir}/style_image/Wedding_dress_2.jpg',
     'model_id': 'YorickHe/polaroid_lora',
     'revision': 'v1.0.0',
     'bin_file': 'InstantPhotoX3.safetensors',
     'multiplier_style': 0.4,
    ...
    {'name': '拍立得风(Polaroid style)',
     'img': f'{project_dir}/style_image/Polaroid_style.jpg',
     'model_id': 'YorickHe/polaroid_lora',
     'revision': 'v1.0.0',
     'bin_file': 'InstantPhotoX3.safetensors',
     'multiplier_style': 0.4,
     ...
     'img': f'{project_dir}/style_image/Fairy_style.jpg',
     ...
     'img': f'{project_dir}/style_image/traditional_chinese_style.jpg',
    ...
    {'name': '壮族服装风(Zhuang style)',
     'img': f'{project_dir}/style_image/Zhuang_style.jpg',
     'model_id': 'iotang/lora_testing',
     'revision': 'v5',
    ...
    {'name': '欧式田野风(European fields)',
     'img': f'{project_dir}/style_image/European_fields.jpg',
     'model_id': 'iotang/lora_testing',
     'revision': 'v5',
    ...
    {'name': '雪山羽绒服风(Jacket in Snow Mountain)',
     'img': f'{project_dir}/style_image/Jacket_in_Snow_Mountain.jpg',
     'model_id': 'iotang/lora_testing',
     'revision': 'v7',
    ...
    {'name': '旗袍风(Cheongsam)',
     'img': f'{project_dir}/style_image/Cheongsam.jpg',
    ...
    {'name': '日系和服风(Kimono Style)',
     'img': f'{project_dir}/style_image/Kimono.jpg',
    ...
    {'name': '贵族公主风(Princess costum)',
     'img': f'{project_dir}/style_image/Princess_style.jpg',
    ...
    {'name': '机械风(Mechanical)',
     'img': f'{project_dir}/style_image/Mechnical.jpg',
    ...
    {'name': '林中鹿女风(deer girl)',
     'img': f'{project_dir}/style_image/Deer_girl.jpg',
    ...
    {'name': '漫画风(cartoon)',
     'img': f'{project_dir}/style_image/cartoon.jpg',
    ...
    {'name': '休闲生活风(Casual Lifestyle)',
     'img': f'{project_dir}/style_image/Casual_Lifestyle.jpg',
    ...
    {'name': '梅花女孩(Chinese Girl among Plum Blossoms)',
     'img': f'{project_dir}/style_image/Chinese_Girl_among_Plum_Blossoms.jpg',
     'model_id': 'theRealSlimShady/AI_portraits',
     'revision': 'v2',
    ...
    {'name': '芭比娃娃(Barbie Doll)',
     'img': f'{project_dir}/style_image/Barbie_Doll.jpg',
     'model_id': 'theRealSlimShady/AI_portraits',
     'revision': 'v2',
    ...
    {'name': '白月光(Innocent Girl in White Dress)',
     'img': f'{project_dir}/style_image/Innocent_Girl_in_White_Dress.jpg',
     'model_id': None,
     'revision': None,
     'bin_file': None,
     'multiplier_style': 0.25,
    ...
    {'name': '优雅公主(Elegant Princess)',
     'img': f'{project_dir}/style_image/Elegant_Princess.jpg',
     'model_id': 'theRealSlimShady/AI_portraits',
     'revision': 'v2',
    ...
    {'name': '鬼马少女(Pixy Girl)',
     'img': f'{project_dir}/style_image/Pixy_Girl.jpg',
     'model_id': 'theRealSlimShady/AI_portraits',
     'revision': 'v2',
