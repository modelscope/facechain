...
styles = [
    ...
    {'name': '雪山羽绒服风(Jacket in Snow Mountain)',
     ...
     'multiplier_style': 1.0,
     'multiplier_human': 0.9,
     'add_prompt_style': '(masterpiece, best quality, ultra detailed, detailed background, cinematic lighting, portrait:1.2), breathtaking 8k, fur, ((jacket)), shirt, pants, winter, (bright sunny day, snow mountain, alpine slopes, snow), gyaru, trendy, gentle hair, slim body'},
]
