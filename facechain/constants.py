...
base_models = [
    ...
    'revision': 'v1.0.0',
    'sub_path': "realistic",
    'style_list': ['泛光', 'anxiang_L', 'MoXinV1', 'Tyndall effect_Light v1.1', '冬季汉服(Chinese winter hanfu)', '校服风(School uniform)', '婚纱风(Wedding dress)', '拍立得风(Polaroid style)', '仙女风(Fairy style)']},
]
...
styles = [
    ...
    {'name': 'Tyndall effect_Light v1.1',
     'model_id': 'iotang/lora_testing',
     'revision': 'v4',
    ...
    {'name': 'anxiang_L',
     'model_id': 'iotang/lora_testing',
     'revision': 'v4',
     'bin_file': 'anxiang_L.safetensors',
