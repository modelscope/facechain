...
styles = [
    ...
    {'name': '湖景汉服风(Lake view Hanfu)',
     ...
     'multiplier_style': 0.7,
     'multiplier_human': 0.95,
     'add_prompt_style': 'Han4, close-up, face shot, chinese clothes,flower,hair ornament, ancient Chinese traditional clothing, close-up, gentle hair, (lake, clouds, pavilion, Overcast and rainy weather, reflection, blurred background)'},
    ...
    {'name': '绅士风(gentleman style)',
     ...
     'multiplier_style': 0.3,
     'multiplier_human': 0.95,
     'add_prompt_style': '1male, close-up, face shot, black classic suit, ties, bowties, wristwatches, cufflink, slicked back, bar background'},
    {'name': '肌肉风(muscular style)',
     'img': './style_image/muscle.jpeg',
     'model_id': 'Licht000/muscle',
     'revision': 'v1.0.0',
     'bin_file': 'bettermalebody_v1.0.safetensors',
     'multiplier_style': 0.3,
     'multiplier_human': 0.95,
     'add_prompt_style': '1male, close-up, face shot, grey tank tops, grey vest, joggers, sports wristbands, short hair, strong, muscular'},
    {'name': '西部牛仔风(west cowboy)',
     'img': './style_image/west cowboy.png',
     'model_id': 'Licht000/cowboy',
     'revision': 'v1.0.0',
     'bin_file': 'James West-000196.safetensors',
     'multiplier_style': 0.3,
     'multiplier_human': 0.95,
     'add_prompt_style': '1male, close-up, face shot, Denim jackets, checkered shirts, leather vests, yellow wide-brimmed hats, bandanas, leather belts with silver buckles, short hair, handguns, horse, tough, desert background'},
    {'name': '嘻哈风(hiphop style)',
     'img': './style_image/hiphop.png',
     'model_id': 'Licht000/hiphop',
     'revision': 'v1.0.1',
     'bin_file': 'edg90hh.safetensors',
     'multiplier_style': 0.3,
     'multiplier_human': 0.95,
     'add_prompt_style': '1male, close-up, face shot, baggy hoodies, sweatshirts, jeans, baseball caps, chunky gold chains, sunglasses, hoop earrings, braids, dreadlocks, graffiti wall background, street'},
    {'name': '洛丽塔(lolita)',
     'img': './style_image/lolita.png',
     'model_id': 'Licht000/lolita',
     'revision': 'v1.0.0',
     'bin_file': 'lolitaV1.safetensors',
     'multiplier_style': 0.3,
     'multiplier_human': 0.95,
     'add_prompt_style': '1girl, close-up, face shot, puffy dresses, lace edges, high-waist skirts, lace gloves, brooches, curled hair, braids, adorned with bows, rosy blush, pink lipsticks, reserved, sweet, girlish, garden background'},
    {'name': '女巫风(witch style)',
     'img': './style_image/witch.png',
     'model_id': 'Licht000/witch',
     'revision': 'v1.0.0',
     'bin_file': 'Moon Witch.safetensors',
     'multiplier_style': 0.3,
     'multiplier_human': 0.95,
     'add_prompt_style': '1girl, close-up, face shot, black robes, lace clothing, long skirts, capes, crystal ball, star and moon jewelry, black hats, and wands, dark wavy hair, adorned with mysterious hairpieces, dark eyeshadows, dark blush, forest background'},
    {'name': '女仆风(maid style)',
     'img': './style_image/maid.png',
     'model_id': 'Licht000/maid',
     'revision': 'v1.0.0',
     'bin_file': 'maid_attire_v2.safetensors',
     'multiplier_style': 0.3,
     'multiplier_human': 0.95,
     'add_prompt_style': '1girl, close-up, face shot, black or white short dresses, lace edges, aprons, bows, lace gloves, neckties, cuffs, twin-tails, light makeup, pink blush, pink lipsticks, gentle, considerate, cafe background'},
]
