...
styles = [
    ...
    {'name': '肌肉风(muscular style)',
     ...
     'multiplier_style': 0.3,
     'multiplier_human': 0.95,
     'add_prompt_style': '1male, grey tank tops, grey vest, joggers, sports wristbands, short hair, strong, muscular'},
