...
def main_diffusion_inference(prompt_cloth, input_img_dir, base_model_path, style_model_path, lora_model_path, multiplier_style=0.25,
...
def main_model_inference(prompt_cloth, use_main_model, input_img_dir=None, base_model_path=None, lora_model_path=None):
    if use_main_model:
        ...
        image = main_diffusion_inference(prompt_cloth, input_img_dir, base_model_path, style_model_path, lora_model_path)
        return image
...
class GenPortrait:
    def __init__(self, prompt_cloth, use_main_model=True, use_face_swap=True,
    ...
    def __call__(self, input_img_dir, num_gen_images=6, base_model_path=None,
        ...
        gen_results = main_model_inference(self.prompt_cloth, self.use_main_model, input_img_dir=input_img_dir,
