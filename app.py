...
def train_input():
    ...
    with gr.Blocks() as demo:
        ...
        with gr.Box():
            ...
            gr.Markdown(
                '''
                - 人物LoRA融合（LoRA-Ensemble）：选择训练中几个与用户最相似的Lora融合，艺术照生成模式建议勾选 - Allow fusion of multiple LoRAs during training. Recommended for enhance similarity or Inpaint mode.
